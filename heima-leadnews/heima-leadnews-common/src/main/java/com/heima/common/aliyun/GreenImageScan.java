...
public class GreenImageScan {
    ...
    @Autowired
    private AliyunConfiguration aliyunConfig;

    public Map imageScan(List<byte[]> imageList) throws Exception {
        IClientProfile profile = DefaultProfile
            .getProfile("cn-shanghai", aliyunConfig.getAccessKeyId(), aliyunConfig.getSecret());
        DefaultProfile
        ...
        httpBody.put("scenes", Arrays.asList(aliyunConfig.getScenes().split(",")));
